...
INSERT INTO Prodotti VALUES (NULL, 'Outlast', 'Outlast.jpg', "video/Outlast.mp4", "Outlast è una serie di giochi survival horror in prima persona sviluppata da Red Barrels. I protagonisti di Outlast non hanno abilità di combattimento. Devono correre, nascondersi o morire. L unica arma che hanno è una videocamera che usano per registrare gli orribili eventi che si dipanano mentre avanzano nel gioco.", '0', '19.99', 'Red Barrels', 'Pc', 'Horror', 'Videogiochi', '2013-09-04', 50);
