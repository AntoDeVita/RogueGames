...
INSERT INTO ClienteReg VALUES ('antoniodevita25@gmail.com', sha2('Client1', 256), 'Antonio', 'De Vita', 21, 'Faiano', '123456789', default, 15);
INSERT INTO ClienteReg VALUES ('g.lavorato@studenti.unisa.it', sha2('Admin1', 256), 'Giovanni', 'Lavorato', 21, 'San Vito', '123456789', 'admin', 7);
INSERT INTO ClienteReg VALUES ('m.battaglia13@studenti.unisa.it', sha2('Client2', 256), 'Marco', 'Battaglia', 21, 'Bellizzi', '123456789', default, 51);
...
INSERT INTO Ordine VALUES (2, 1, 'antoniodevita25@gmail.com', 399.99, 1, '2021-07-03');
...
INSERT INTO Ordine VALUES (4, 5, 'antoniodevita25@gmail.com', 2.00, 1, '2024-01-07');
...
(
	...
	PRIMARY KEY (Email, idOrdine, idProdotto),
	CONSTRAINT Coll
    FOREIGN KEY (Email) REFERENCES clientereg(Email),
    FOREIGN KEY (idOrdine, idProdotto) REFERENCES Ordine(idOrdine,idProdotto)
	ON DELETE NO ACTION
	ON UPDATE NO ACTION
)ENGINE = InnoDB;
