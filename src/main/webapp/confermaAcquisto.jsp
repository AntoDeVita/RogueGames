...
<body>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <button id="acquistaBtn" class="btn btn-purchase mt-3">Acquista</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="thankYouPopup" class="popup">
        <div class="popup-content">
            ...
            <button id="closePopupBtn" class="btn btn-secondary">Chiudi</button>
        </div>
    </div>
    ...
    <script src="script/confermaAcquisto.js"></script>
</body>
</html>
