...
public class prodottiDAO2 implements IBeanDAO<prodottoBean>{
	...
	public synchronized void doSave(prodottoBean product) throws SQLException {
		...
		try {
			...
			preparedStatement.setString(7, product.getCasaProduttrice());
			preparedStatement.setString(8, product.getPiattaforma());
			preparedStatement.setString(9, product.getGenere());
			preparedStatement.setString(10, product.getTipo());
			preparedStatement.setString(11, product.getDataRilascio());
	...
	public void doUpdateQnt(int id, int qnt) throws SQLException {
		...
		try {
			...
			prodottoBean p=doRetrieveByKey(id);
			preparedStatement.setInt(1, p.getQuantita()-qnt);
